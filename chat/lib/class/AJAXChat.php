	...
	function getGuestUser() {
		...
		if($this->getConfig('allowGuestUserName')) {
			...
			$userName = $this->createGuestUserName();
                 ...
                 $inf = "";$nom="";$prenom="";$code_profil="";$numero_eleve="";
		...
		$userData['userID'] = $this->createGuestUserID();
                ...
                if($code_profil == 'etudiant')
		$userData['userName'] =$prenom.$nom.$numero_eleve;
                else  if($code_profil == 'professeur' || $code_profil == 'directeur')
		 ...
		 $userData['userRole'] = AJAX_CHAT_USER;
                else  if($code_profil == 'professeur')
                 $userData['userRole'] = AJAX_CHAT_MODERATOR;
                else  if($code_profil == 'directeur')
