...
?></td>
    ...
    <br>    <br>    <br>   <table><tr><td class="title" style="width: 95%; border:none;background:white" >FICHE DE NOTE <strong><?php print("$classe") ?> </strong></td></tr></table><br>    <br>    
        <table><tr>
		<td class="title" style="width: 40%; border:none;background:white" >Mati&egrave;re: ____________ </td>
		<td style="width: 25%; border:none;background:white">Semestre:______________ </td>
		<td class="title" style="width: 45%; border:none;background:white" >Type : _______________</td>
		</tr></table><br>    <br>    
        ...
        <tr>           
			...
			<th style="width: 25%">Appr&eacute;ciation</th>
	...
	<?php
        for ($indexEnc = 0; $indexEnc < $index; $indexEnc++) {
            ...
            <tr><td style="width: 25%"><?php print(number_format($donnesNum[$indexEnc], 0, ',', ' ')) ?></td>
                ...
                <td style="width: 17%;background-color:white;"></td>
				<td style="width: 25%;background-color:white;"></td></tr>
            <?php
        }
        ?>	
