...
$annee_scolaire="";
 ...
 if (isset($_GET['numEleve']) && isset($_GET['annee_scolaire'])) {
    ...
    $reponseEleve = $bdd->query("SELECT e.nom as nom, e.prenom as prenom, u.adresse as adresse, u.telephone as telephone, 
					  ...
					  where e.id_parent= u.id and  c.id_classe= i.id_classe and e.numero_eleve= i.numero_eleve  and e.numero_eleve = '$numEleve'");

    $reponse = $bdd->query("SELECT  f.numero_facture as numero, f.libelle as libelle,f.montant as montant,
